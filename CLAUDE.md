...
- `unsafe` は mlock/VirtualLock/PR_SET_DUMPABLE/IsDebuggerPresent/SetErrorMode・GetErrorMode (WER/クラッシュダンプ抑止)/Win32 Console API (GetConsoleMode/SetConsoleMode/ReadConsoleW) のみ許可。それ以外は禁止
